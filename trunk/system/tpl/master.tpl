		...
		<div class="clear"></div>	
			...
			<ul>					
				<li><a href="/about/index">About Us</a></li>					
					...
					{{else}}					
					<a href="/login" class="icon"><img src="/img/icon_login.png" />Login</a>					
					{{/if}}				
					</li>				
					{{if $currentUser->checkPermissions(100, false)}}				
					<li class="secondary">					
					<a href="/admin/index" class="icon"><img src="/img/icon_admin.png" />Admin</a>					
					<ul>						
					{{if $page->common}}<li><a href="/help/view?common={{$page->common}}&height=500&width=800" class="thickbox"><img class="icon" src="/img/icon_help.png" />Help </a></li>{{/if}}						
