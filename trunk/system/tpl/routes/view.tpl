...
{{if $route_view->getIsOwner($currentUser->uid)}}
	...
	{{if $route_view->getCanEdit()}}
		...
		<a href="/routes/create.php?rid={{$route_view->id}}" class="icon"><img src="/img/icon.png" />Edit</a>
		<a href="/routes/create.php?rid={{$route_view->id}}&mode=copy" class="icon"><img src="/img/icon.png" />Copy/Edit</a>
