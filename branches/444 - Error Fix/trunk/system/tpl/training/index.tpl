...
<div class="grid_9">
	<div id="chart_select" class="align_right">
		<p>Chart type: 		
			<input id="dist_rad" type="radio" name="c_type" value="dista" checked="checked" /><label>Distance</label>
			<input id="pace_rad" type="radio" name="c_type" value="pac" /><label>Pace</label>
		</p>
	</div>
