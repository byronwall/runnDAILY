...
<div class="grid_12">
	...
	{{if $item->getIsOwnedBy($currentUser->uid)}}
		<a href="#TB_inline?&height=150&width=300&inlineId=training_edit_modal&modal=true" class="thickbox"><img class="icon" src="/img/icon.png" />Edit</a>
		<a href="#TB_inline?&height=100&width=400&inlineId=training_delete_modal&modal=true" class="thickbox"><img class="icon" src="/img/icon.png" />Delete</a>
	{{/if}}
	</div>
</div>
<div class="clear"></div>
