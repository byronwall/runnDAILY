...
<div class="grid_12">
	...
	{{foreachelse}}
	<div>
		<p>You do not currently have any training items within this goal's date range. <a href="/training/create" class="icon"><img src="/img/icon/training_plus.png" />Create</a> a new training item to enable advanced features.</p>
	</div>
	{{/foreach}}
